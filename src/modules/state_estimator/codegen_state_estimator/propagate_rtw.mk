...
MODEL                = HyEst
MODULES              = propagate_rtwutil.c propagate_data.c propagate_initialize.c propagate_terminate.c propagate.c rdivide.c autogen_FPF_const_wind.c autogen_FPF.c rt_nonfinite.c rtGetNaN.c rtGetInf.c 
MAKEFILE             = propagate_rtw.mk
...
MODELLIB                  = HyEst.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = propagate_ref.rsp
MODELREF_INC_PATH         = 
