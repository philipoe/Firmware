...
MODEL                = HyEst
MODULES              = HyEst_rtwutil.c HyEst_data.c HyEst_initialize.c HyEst_terminate.c propagate.c rdivide.c mpower.c dot.c autogen_FPF_const_wind.c autogen_FPF.c magField.c initStates.c cross.c norm.c diag.c updatePosition.c mldivide.c updateVelNed.c pinv.c updateCompass2.c updatePressures.c updatePressures_all.c autogen_TasUpdate_withAerodynamics_alpha_set.c autogen_TasUpdate_withAerodynamics.c updatePressures2.c autogen_pressure2.c inv.c quat2rpy.c getAirplane.c HyEst_emxutil.c rt_nonfinite.c rtGetNaN.c rtGetInf.c 
MAKEFILE             = HyEst_rtw.mk
MATLAB_ROOT          = C:\Program Files\MATLAB\R2012b_x64
ALT_MATLAB_ROOT      = C:\PROGRA~1\MATLAB\R2012B~1
MATLAB_BIN           = C:\Program Files\MATLAB\R2012b_x64\bin
ALT_MATLAB_BIN       = C:\PROGRA~1\MATLAB\R2012B~1\bin
S_FUNCTIONS          = 
S_FUNCTIONS_LIB      = 
SOLVER               = 
NUMST                = 1
...
MODELLIB                  = HyEst.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = HyEst_ref.rsp
MODELREF_INC_PATH         = 
RELATIVE_PATH_TO_ANCHOR   = C:\Users\melzeram\DOCUME~1\NAVIGA~1\hyest\CODE_G~1
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\Users\melzeram\Documents\Navigation_Algorithm\hyest\code_generation\px4
